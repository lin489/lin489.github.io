            ...
            drawAreaMeasureGraphics: function (options = {}) {
                ...
                if (this._viewer && options) {
                    ...
                    _handler.setInputAction(function (movement) {
                        ...
                        newEntity = polyObj;
                        console.log(polyObj)
                        AddProperties(($this.getPositionsArea($this.transformCartesianArrayToWGS84Array(positions)) / 1.0).toFixed(4));
                    ...
                    function create() {
                        ...
                        newEntity = _polygonEntity;
                        try{
                            targetDatasource.entities.add(_polygonEntity);
